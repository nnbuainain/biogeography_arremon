...
#mtDNA dataset
#trfn = np(paste(addslash("./"), "arremonult.tre", sep=""))
#geogfn = np(paste(addslash("./"), "arremon_geo.dat", sep=""))
#tr<-read.tree("./arremonult.tre")
#uce dataset
trfn = np(paste(addslash("./"), "all.tre", sep=""))
geogfn = np(paste(addslash("./"), "arremon_geo_4.dat", sep=""))
tr<-read.tree("./all.tre")
...
# PDF plots
#######################################################
pdffn = "arremon_DEC_vs_DEC+J.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on arremon"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tipranges=tipranges)

#######################################################
# Plot ancestral states - DECJ
#######################################################

analysis_titletxt ="BioGeoBEARS DEC+J on Arremon"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tipranges=tipranges)
...
#In case an error regarding the inital value of the run pops out, redifine it with":
#BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["e","init"] = estart

resfn = "Arremon_DIVALIKE+J.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Arremon_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Arremon"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Arremon"
...
runslow = TRUE
resfn = "Arremon_BAYAREALIKE.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
pdffn = "Arremon_BAYAREALIKE_vs_BAYAREALIKE.pdf"
pdf(pdffn, width=6, height=6)
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Arremon"
